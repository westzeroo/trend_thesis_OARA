...
data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 then both=1;
else if subject=1 and sex=1  and osteo=0 then both=0; 
run;
...
data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 and age_gg = 1 then a1_b=1; 
else if subject=1 and sex=1  and osteo=0  and age_gg = 1 then a1_b=0; 
run;

data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 and age_gg = 2 then a2_b=1; 
else if subject=1 and sex=1  and osteo=0  and age_gg = 2 then a2_b=0; 
run;

data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 and age_gg = 3 then a3_b=1; 
else if subject=1 and sex=1  and osteo=0 and age_gg = 3 then a3_b=0; 
run;

/*OA w/ sex*/
data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 and sex=1 then m_b=1; 
else if subject=1 and sex=1  and osteo=0 and sex=1 then m_b=0; 
run;

data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 and sex=2 then w_b=1; 
else if subject=1 and sex=1  and osteo=0 and sex=2  then w_b=0; 
run;

/*OA w/ region*/
data y15; 
set y15;
if subject=1 and sex=1  and osteo=1 and town_t=1 then u_b=1; 
else if subject=1 and sex=1  and osteo=0  and town_t=1 then u_b=0; 
run;

data y15; 
set y15;
if subject=1 and sex=1  and osteo=1 and town_t=2 then r_b=1; 
else if subject=1 and sex=1  and osteo=0  and town_t=2 then r_b=0; 
run;

/*OA w/ education*/
data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 and grade_1=1 then e1_b=1;
else if subject=1 and sex=1  and osteo=0  and grade_1=1 then e1_b=0; 
run;

data y15; 
set y15; 
if subject=1 and sex=1  and osteo=1 and grade_1=2 then e2_b=1;
else if subject=1 and sex=1  and osteo=0  and grade_1=2 then e2_b=0; 
run;

/*OA w/ y15*/
data y15;
set y15; 
if subject=1 and sex=1  and osteo=1 and ho_incm_2=1 then i1_b=1; 
else if subject=1 and sex=1  and osteo=0  and ho_incm_2=1 then i1_b=0; 
run;

data y15;
set y15; 
if subject=1 and sex=1  and osteo=1 and ho_incm_2=2 then i2_b=1; 
else if subject=1 and sex=1  and osteo=0  and ho_incm_2=2 then i2_b=0; 
run;

/*OA w/ smoking*/
data y15; 
set y15;
if subject=1 and sex=1  and osteo=1 and smoking_2=1 then s1_b=1; 
else if subject=1 and sex=1  and osteo=0 and smoking_2=1 then s1_b=0;
run;

data y15; 
set y15;
if subject=1 and sex=1  and osteo=1 and smoking_2=2 then s2_b=1; 
else if subject=1 and sex=1  and osteo=0 and smoking_2=2 then s2_b=0;
run;

/*OA w/ bmi*/
data y15; 
set y15;
if subject=1 and sex=1  and osteo=1 and bmi_2=1 then b1_b=1; 
else if subject=1 and sex=1  and osteo=0 and bmi_2=1 then b1_b=0;
run;

data y15; 
set y15;
if subject=1 and sex=1  and osteo=1 and bmi_2=2 then b2_b=1; 
else if subject=1 and sex=1  and osteo=0 and bmi_2=2 then b2_b=0;
run;
...
data y16; 
set y14; 
if subject=1 and sex=2  and osteo=1 then both=1;
else if subject=1 and sex=2  and osteo=0 then both=0; 
run;

/*OA w/ age_g*/
data y16; 
set y16; 
if subject=1 and sex=2  and osteo=1 and age_gg = 1 then a1_b=1; 
else if subject=1 and sex=2  and osteo=0  and age_gg = 1 then a1_b=0; 
run;

data y16; 
set y16; 
if subject=1 and sex=2  and osteo=1 and age_gg = 2 then a2_b=1; 
else if subject=1 and sex=2  and osteo=0  and age_gg = 2 then a2_b=0; 
run;

data y16; 
set y16; 
if subject=1 and sex=2  and osteo=1 and age_gg = 3 then a3_b=1; 
else if subject=1 and sex=2  and osteo=0 and age_gg = 3 then a3_b=0; 
run;

/*OA w/ sex*/
data y16; 
set y16; 
if subject=1 and sex=2  and osteo=1 and sex=1 then m_b=1; 
else if subject=1 and sex=2  and osteo=0 and sex=1 then m_b=0; 
run;

data y16; 
set y16; 
if subject=1 and sex=2  and osteo=1 and sex=2 then w_b=1; 
else if subject=1 and sex=2  and osteo=0 and sex=2  then w_b=0; 
run;

/*OA w/ region*/
data y16; 
set y16;
if subject=1 and sex=2  and osteo=1 and town_t=1 then u_b=1; 
else if subject=1 and sex=2  and osteo=0  and town_t=1 then u_b=0; 
run;

data y16; 
set y16;
if subject=1 and sex=2  and osteo=1 and town_t=2 then r_b=1; 
else if subject=1 and sex=2  and osteo=0  and town_t=2 then r_b=0; 
run;

/*OA w/ education*/
data y16; 
set y16; 
if subject=1 and sex=2  and osteo=1 and grade_1=1 then e1_b=1;
else if subject=1 and sex=2  and osteo=0  and grade_1=1 then e1_b=0; 
run;

data y16; 
set y16; 
if subject=1 and sex=2  and osteo=1 and grade_1=2 then e2_b=1;
else if subject=1 and sex=2  and osteo=0  and grade_1=2 then e2_b=0; 
run;

/*OA w/ y15*/
data y16;
set y16; 
if subject=1 and sex=2  and osteo=1 and ho_incm_2=1 then i1_b=1; 
else if subject=1 and sex=2  and osteo=0  and ho_incm_2=1 then i1_b=0; 
run;

data y16;
set y16; 
if subject=1 and sex=2  and osteo=1 and ho_incm_2=2 then i2_b=1; 
else if subject=1 and sex=2  and osteo=0  and ho_incm_2=2 then i2_b=0; 
run;

/*OA w/ smoking*/
data y16; 
set y16;
if subject=1 and sex=2  and osteo=1 and smoking_2=1 then s1_b=1; 
else if subject=1 and sex=2  and osteo=0 and smoking_2=1 then s1_b=0;
run;

data y16; 
set y16;
if subject=1 and sex=2  and osteo=1 and smoking_2=2 then s2_b=1; 
else if subject=1 and sex=2  and osteo=0 and smoking_2=2 then s2_b=0;
run;

/*OA w/ bmi*/
data y16; 
set y16;
if subject=1 and sex=2  and osteo=1 and bmi_2=1 then b1_b=1; 
else if subject=1 and sex=2  and osteo=0 and bmi_2=1 then b1_b=0;
run;

/*OA prevalence*/
data y16; 
set y16;
if subject=1 and sex=2  and osteo=1 and bmi_2=2 then b2_b=1; 
else if subject=1 and sex=2  and osteo=0 and bmi_2=2 then b2_b=0;
run;
...
data y17; 
set y14; 
if subject=1 and osteo=1 then both=1;
else if subject=1 and osteo=0 then both=0; 
run;

/*OA w/ age_g*/
data y17; 
set y17; 
if subject=1 and osteo=1 and age_gg = 1 then a1_b=1; 
else if subject=1 and osteo=0  and age_gg = 1 then a1_b=0; 
run;

data y17; 
set y17; 
if subject=1 and osteo=1 and age_gg = 2 then a2_b=1; 
else if subject=1 and osteo=0  and age_gg = 2 then a2_b=0; 
run;

data y17; 
set y17; 
if subject=1 and osteo=1 and age_gg = 3 then a3_b=1; 
else if subject=1 and osteo=0 and age_gg = 3 then a3_b=0; 
run;

/*OA w/ sex*/
data y17; 
set y17; 
if subject=1 and osteo=1 and sex=1 then m_b=1; 
else if subject=1 and osteo=0 and sex=1 then m_b=0; 
run;

data y17; 
set y17; 
if subject=1 and osteo=1 and sex=2 then w_b=1; 
else if subject=1 and osteo=0 and sex=2  then w_b=0; 
run;

/*OA w/ region*/
data y17; 
set y17;
if subject=1 and osteo=1 and town_t=1 then u_b=1; 
else if subject=1 and osteo=0  and town_t=1 then u_b=0; 
run;

data y17; 
set y17;
if subject=1 and osteo=1 and town_t=2 then r_b=1; 
else if subject=1 and osteo=0  and town_t=2 then r_b=0; 
run;

/*OA w/ education*/
data y17; 
set y17; 
if subject=1 and osteo=1 and grade_1=1 then e1_b=1;
else if subject=1 and osteo=0  and grade_1=1 then e1_b=0; 
run;

data y17; 
set y17; 
if subject=1 and osteo=1 and grade_1=2 then e2_b=1;
else if subject=1 and osteo=0  and grade_1=2 then e2_b=0; 
run;

/*OA w/ ho_incm*/
data y17;
set y17; 
if subject=1 and osteo=1 and ho_incm_2=1 then i1_b=1; 
else if subject=1 and osteo=0  and ho_incm_2=1 then i1_b=0; 
run;

data y17;
set y17; 
if subject=1  and osteo=1 and ho_incm_2=2 then i2_b=1; 
else if subject=1 and osteo=0  and ho_incm_2=2 then i2_b=0; 
run;

/*OA w/ smoking*/
data y17; 
set y17;
if subject=1 and osteo=1 and smoking_2=1 then s1_b=1; 
else if subject=1 and osteo=0 and smoking_2=1 then s1_b=0;
run;

data y17; 
set y17;
if subject=1 and osteo=1 and smoking_2=2 then s2_b=1; 
else if subject=1 and osteo=0 and smoking_2=2 then s2_b=0;
run;

/*OA w/ bmi*/
data y17; 
set y17;
if subject=1 and osteo=1 and bmi_2=1 then b1_b=1; 
else if subject=1 and osteo=0 and bmi_2=1 then b1_b=0;
run;

data y17; 
set y17;
if subject=1 and osteo=1 and bmi_2=2 then b2_b=1; 
else if subject=1 and osteo=0 and bmi_2=2 then b2_b=0;
run;
...
model osteo (event='1')=&class_variable;
